<?php
//Vista de la lista de resultaods y enfrentamientos de los torneos
session_start();
...
if (isset($_SESSION["competidor"]) || isset($_SESSION["coach"]) || isset($_SESSION["arbitro"])) {
    ...
    //error_log(print_r($enfrentamientos, true));
    ...
    <html>
        ...
        <body>
            ...
            if ( !empty($enfrentamientos)) {
                ...
                <div class="container">
                    <?php
                    print "<a href='listaCategoriasResultados.php?idtorneo=" . $idTorneo . "'><button type='button' id='volverACategorias' name='volverACategorias' class='btn btn-success'>".$lang["VolverCategorias"]."</button></a>";
