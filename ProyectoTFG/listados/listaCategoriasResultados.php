<?php
//Vista de la lista de categorías  de los resultados y enfrentamientos de los torneos
session_start();
...
if (isset($_SESSION["competidor"]) || isset($_SESSION["coach"]) || isset($_SESSION["arbitro"])) {
    ...
    <html>
        ...
        <body>
            ...
            <?php    
            if (empty($categorias)) {
                print "<h2 class='textoCentrado'>".$lang["NoResultadosTorneo"]."</h2>";
            }else{
            ?>
                ...
                <table class="table table-striped" id="tablaResultados">
                    ...
                    <tbody>
                        ...
                        foreach ($categorias as $categoria) {
                            ...
                            print "<td><a href='listaResultados.php?idtorneo=" . $idTorneo . "&peso=" . $categoria->getPeso() . "&sexo=" . $categoria->getSexo() . "&edad=" . $categoria->getEdad() . "&modalidad=" . $categoria->getModalidad() . "'><button type='button' name='resultados' class='btn btn-success'>".$lang["VerInformacion"]."</button></a></td>";
                            print "</tr>";
                        }
                        ?>
                    </tbody>
