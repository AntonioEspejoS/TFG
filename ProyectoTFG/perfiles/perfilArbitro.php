<?php
//Vista para el perfil del árbitro
session_start();
...
?>
    <html>
        <head>
            ...
            <title><?php echo $lang["PerfilArbitro"]?></title>
        ...
        <body>
            ...
            <?php include '../menus/menuArbitro.php'; ?>
            <section>
                <div class="container">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                $arbitro = $arbitroModelo->obtenerArbitroPorDNI($dni);
                                    ...
                                    print "<th>DNI</th>";
                                    print "<td id='celdaDNI'>" . $arbitro->getDni() . "</td>";
                                    print "</tr>";

                                    print "<tr>";
                                    print "<th>".$lang["Pass"]."</th>";
                                    print "<td> <input type='password' class='pass' readonly id='password1' value='" . $arbitro->getContrasena(). "'> <div class='ver' id='mostrarPass'></div></td>";
                                    print "<th>".$lang["Correo"]."</th>";
                                    print "<td>" . $arbitro->getCorreo() . "<input type='button'class='btn btn-warning-custom botonAmarilloPerfil cambiarCorreoArbitro' id='" . $arbitro->getDni() . "' value='".$lang["EditarCorreo"]."'></td>";
                                    print "</tr>";
                                ?>
                            </tbody>
                        </table>
                    </div>
                       <a href="../registro/registrarseRol.php?dni=<?php echo $dni; ?>&rol=arbitro">
            ...
            <div class="oculto" id="dialogoCambiarCorreoArbitro" title="<?php echo $lang["EditarCorreo"]?>">
                <form action="" method="post" id="formularioCorreoEditar" name="formularioCorreoEditar">
                    ...
                    <div class="form-group text-center">
                        <input type="button" id="editarCorreoArbitro"  class="btn btn-primary"  value="<?php echo $lang["EditarCorreo"]?>">
                    </div>     
