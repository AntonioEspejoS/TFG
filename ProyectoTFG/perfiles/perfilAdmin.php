<?php
//Vista para el perfil del administrador del sistema
session_start();
...
?>
    <html>
        <head>
            ...
            <title><?php echo $lang["PerfilAdmin"]?></title>
        ...
        <body>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                $admin = $adminModelo->obtenerAdminPorDNI($dni);
                                    ...
                                    print "<td>" . $admin->getNombre() . "</td>";
                                    print "<th>DNI</th>";
                                    print "<td id='celdaDNI'>" . $admin->getDni() . "</td>";
                                    print "</tr>";
                                    print "<tr>";
                                    print "<th>".$lang["Pass"]."</th>";
                                    print "<td> <input type='password' class='pass' readonly id='password1' value='" . $admin->getContrasena(). "'> <div class='ver' id='mostrarPass'></div></td>";
                                    print "<th>".$lang["Correo"]."</th>";
                                    print "<td>" . $admin->getCorreo() . "<input type='button'class='btn btn-warning-custom botonAmarilloPerfil cambiarCorreoAdmin' id='" . $admin->getDni() . "' value='".$lang["EditarCorreo"]."'></td>";
                                    print "</tr>";
                                ?>
                            </tbody>
                        </table>
                    </div>
                       <a href="../registro/registrarseRol.php?dni=<?php echo $dni; ?>&rol=admin">
            ...
            <div class="oculto" id="dialogoCambiarCorreoAdmin" title="<?php echo $lang["EditarCorreo"]?>">
                <form action="" method="post" id="formularioCorreoEditar" name="formularioCorreoEditar">
                    ...
                    <div class="form-group text-center">
                        <input type="button" id="editarCorreoAdmin"  class="btn btn-primary"  value="<?php echo $lang["EditarCorreo"]?>">
                    </div>   
                </form>
            </div>
